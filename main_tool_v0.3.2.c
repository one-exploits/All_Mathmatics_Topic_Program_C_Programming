  ...
  while (1)
	{
		...
		if (func_option==1)
		{
			while (1)
			{
					...
					printf(" _ _|_   _| | | |   |_   _|   ___   _ __   _ __ ___  \n");
					printf("| '_ \\| | | |_| |_____| |    / _ \\ | '__| | '_ ` _ \\ \n");
					printf("| | | | | |  _  |_____| |   |  __/ | |    | | | | | |\n");
					printf("|_| |_|_| |_| |_|     |_|    \\___| |_|    |_| |_| |_|");
					printf(" Of Arithmeric Progression.\n");
		...
		else if (func_option==2)
		{
			...
			{
					printf(" ____          _____                           \n");
					printf("/ ___| _ __   |_   _|   ___   _ __   _ __ ___  \n");
					printf("\\___ \\| '_ \\    | |    / _ \\ | '__| | '_ ` _ \\ \n");
					printf(" ___) | | | |   | |   |  __/ | |    | | | | | |\n");
					printf("|____/|_| |_|   |_|    \\___| |_|    |_| |_| |_|");
					printf(" Sum Of n Term In Arithmetic Progression.");
					int last__option;
				last__option=last_option_after_each_calculation(77,88,99);
				if(last__option==77){
					//calculate more
		...
		else if (func_option==3)
		{
			while (1)
			{
					printf(" _   _                         _____                           \n");
					printf("| \\ | |  _   _   _ __ ___     |_   _|   ___   _ __   _ __ ___  \n");
					printf("|  \\| | | | | | | '_ ` _ \\      | |    / _ \\ | '__| | '_ ` _ \\ \n");
					printf("| |\\  | | |_| | | | | | | |_    | |   |  __/ | |    | | | | | |\n");
					printf("|_| \\_|  \\__,_| |_| |_| |_(_)   |_|    \\___| |_|    |_| |_| |_|");
					printf(" In sum Of Term (AP).\n");
					int last__option;
				last__option=last_option_after_each_calculation(77,88,99);
				if(last__option==77){
					//calculate more
